  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="flex cols-span-2 row-span-2 max-w-[600px] w-full -mt-5 sm:mt-20 md:mt-16"
      >
        <input
          className="bg-gray-400 dark:bg-gray-300 text-gray-900 rounded-lg p-2 outline-none placeholder:text-gray-200 m-2 h-8"
          type="text"
          placeholder="Name"
          name="name"
          required
        ...
        />
        <textarea
          className="bg-gray-400 dark:bg-gray-300 text-gray-800 rounded-lg p-2 outline-none placeholder:text-gray-200 row-start-2"
          name="message"
          rows="10"
          placeholder="Message"
          required
