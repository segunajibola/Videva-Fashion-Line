  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="grid grid-cols-2 grid-rows-3 gap-4 max-w-[600px] w-full -mt-5 sm:mt-20 md:mt-16"
      >
        {/* <div className=""> */}
          <input
            className="bg-gray-400 dark:bg-gray-300 text-gray-900 rounded-lg p-2 outline-none placeholder:text-gray-200 m-2 border-4 h-8"
            type="text"
            placeholder="Name"
            name="name"
            required
        ...
        {/* <div className="border-4 border-blue-200 bg-green-50 h-16"> */}
          ...
          />
        {/* </div> */}
        <div className="row-start-2 col-span-2 border-4">
          <textarea
        ...
        <button className="bg-gray-400 dark:bg-gray-300 text-gray-100 border-2 hover:text-gray-800 hover:bg-gray-100 hover:border-gray-200 px-4 py-3 my-8 mx-auto flex items-center dark:text-gray-900 dark:border-gray-500 dark:hover:bg-gray-300 dark:hover:border-gray-800 row-start-3 col-span-2">
          Send mail
        </button>
      </form>
    </section>
